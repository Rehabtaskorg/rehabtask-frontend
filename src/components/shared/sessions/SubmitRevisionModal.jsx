...
export default function SubmitRevisionModal({
    ...
    return (
        ...
        >
            <div className="bg-card-light  rounded-xl w-full max-w-lg shadow-2xl overflow-hidden">
                {/* Header */}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    {revisionReason && (
                        <div className="bg-muted-light  border-l-4 border-primary/40 rounded-r-lg p-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            disabled={submitting}
                            className="w-full px-4 py-2.5 rounded-lg border border-border-light  bg-background-light  text-text-main  text-sm focus:outline-none focus:ring-2 focus:ring-primary transition-all scheme-light "
                        />
