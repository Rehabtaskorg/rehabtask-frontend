...
export default function ChatHeader({ selected, selectedConversation, onBack, headerActions }) {
    ...
    return (
        <div className="flex items-center justify-between px-4 md:px-6 py-3 border-b border-border-light  bg-card-light  shrink-0">
            <div className="flex items-center gap-3 min-w-0">
                <button onClick={onBack} className="md:hidden flex items-center justify-center h-8 w-8 rounded-lg hover:bg-muted-light  transition-colors text-text-muted  shrink-0" aria-label="Back to conversations">
                ...
                <div className="min-w-0">
                    <div className="flex items-center gap-2">
                        <h3 className="text-base font-bold text-text-main  truncate">{selected.name}</h3>
