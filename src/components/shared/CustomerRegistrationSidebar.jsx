...
const CustomerRegistrationSidebar = () => {
    return (
        <aside className="w-full lg:w-100 bg-white dark:bg-background-dark border-r border-border-subtle dark:border-[#2a3038] p-8 lg:p-12 flex flex-col justify-between">
                    ...
                    {BENEFITS.map((benefit) => {
                        ...
                        return (
                            <div key={benefit.title} className="flex gap-4">
                                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-background-light dark:bg-card-dark text-primary">
