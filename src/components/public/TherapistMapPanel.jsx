...
import { MdStar, MdLocationOn, MdLock } from "react-icons/md";
...
function AggregateInfoWindow({ marker, onAuthGate }) {
    return (
            ...
            >
                ...
                {activeMarker && (
                    <InfoWindow
                        ...
                        headerDisabled
                    >
                        <AggregateInfoWindow marker={activeMarker} onAuthGate={onAuthGate} />
                    </InfoWindow>
                )}
            </Map>
        </div>
