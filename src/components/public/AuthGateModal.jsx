...
export default function AuthGateModal({ isOpen, onClose, trigger = "default", redirectPath = "/" }) {
    useEffect(() => {
                ...
                >
                    ...
                    >
                        ...
                        <div className="text-center">
                            <div className="mx-auto w-14 h-14 rounded-full bg-[#137fec]/10 flex items-center justify-center mb-5">
                                <MdLock className="text-2xl text-[#137fec]" />
                            </div>
                        ...
                        <div className="mt-6 space-y-3">
                            <Link
                                ...
                                className="block w-full py-3 text-center text-sm font-semibold text-white bg-[#137fec] rounded-xl hover:bg-[#137fec]/90 transition-colors"
                            >
                        ...
                        <p className="mt-4 text-center text-sm text-gray-500">
                            ...
                            <Link href={`/login?redirect=${redirect}`} className="text-[#137fec] font-semibold hover:underline">
                                Log in
                            </Link>
                        </p>
