    ...
    return (
        <div className="p-4 md:p-6 max-w-7xl mx-auto animate-pulse">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                {[1, 2, 3].map((i) => (
                    <div key={i} className="bg-card-light  border border-border-light  rounded-xl p-6">
            ...
            <div className="bg-card-light  border border-border-light  rounded-xl p-6 mb-8">
            ...
            <div className="bg-card-light  border border-border-light  rounded-xl p-6">
                ...
                {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="flex items-center gap-4 py-4 border-b border-border-light  last:border-b-0">
