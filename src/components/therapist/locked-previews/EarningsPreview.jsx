const StatCard = ({ iconColor }) => (
    <div className="bg-card-light dark:bg-card-dark border border-border-light dark:border-border-dark rounded-xl p-6 relative overflow-hidden">
        ...
        <div className="h-3 w-28 bg-slate-200 dark:bg-slate-700 rounded mb-2" />
        ...
        <div className="p-4 md:p-6 max-w-7xl mx-auto space-y-6" aria-hidden="true">
            ...
            <div className="bg-card-light dark:bg-card-dark border border-border-light dark:border-border-dark rounded-xl overflow-hidden">
                <div className="p-6 pb-3">
                    ...
                    <div className="flex gap-2 pb-3 border-b border-border-light dark:border-border-dark">
                        {[1, 2, 3, 4].map((i) => (
                ...
                {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="flex items-center gap-4 px-6 py-4 border-b border-border-light dark:border-border-dark last:border-b-0">
                        ...
                        <div className="h-4 w-14 bg-red-100 dark:bg-red-900/20 rounded" />
                        <div className="h-4 w-14 bg-emerald-100 dark:bg-emerald-900/20 rounded" />
                        <div className="h-6 w-16 bg-emerald-100 dark:bg-emerald-900/20 rounded-full" />
                    </div>
                ))}
            </div>
        </div>
