            ...
            <div className="lg:col-span-7 space-y-3">
                ...
                {hasChangeNote && (
                    <div className="bg-amber-50  border border-amber-200  rounded-lg p-3">
                        ...
                        <div className="h-3 w-2/3 bg-amber-100  rounded mt-1.5" />
                    </div>
                )}
                <div className="flex items-center gap-3 text-sm divide-x divide-border-light ">
                    <div className="h-3 w-20 bg-slate-100  rounded" />
                    <div className="h-3 w-16 bg-slate-100  rounded pl-3" />
                    <div className="h-3 w-24 bg-slate-100  rounded pl-3" />
                    <div className="h-3 w-16 bg-slate-100  rounded pl-3" />
                </div>
            </div>
    ...
    return (
        <div className="p-4 md:p-6 space-y-6" aria-hidden="true">
            ...
            <div className="flex items-center gap-3 px-4 py-3 bg-amber-50  border border-amber-200  rounded-xl">
                <div className="w-5 h-5 rounded-full bg-amber-300  shrink-0" />
                <div className="h-4 w-64 bg-amber-100  rounded" />
                <div className="h-7 w-36 bg-amber-200  rounded-lg ml-auto" />
            </div>
            ...
            <div className="flex flex-wrap gap-2">
                {STATUS_TABS.map((tab) => (
                    ...
                    >
                        <div className={`h-3 ${tab.label.length > 8 ? "w-28" : "w-12"} ${tab.active ? "bg-primary/30" : "bg-slate-200 "} rounded`} />
            ...
            <div className="space-y-4">
                <OfferCard statusColor="bg-amber-200 " statusWidth="w-16" hasChangeNote={false} />
                <OfferCard statusColor="bg-amber-200 " statusWidth="w-28" hasChangeNote={true} />
                <OfferCard statusColor="bg-emerald-200 " statusWidth="w-18" hasChangeNote={false} />
                <OfferCard statusColor="bg-slate-200 " statusWidth="w-16" hasChangeNote={false} />
            </div>
        </div>
    );
}
