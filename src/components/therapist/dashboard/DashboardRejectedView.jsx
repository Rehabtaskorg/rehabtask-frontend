    ...
    return (
        <div className="p-4 sm:p-8">
            <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8">
                ...
                {/* Rejection Alert */}
                <div className="flex items-start gap-3 p-5 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl">
                        ...
                        {QUICK_ACTIONS.map((action) => {
                            ...
                            return (
                                <Wrapper
                                    key={action.label}
                                    {...wrapperProps}
                                    className="flex flex-col items-start gap-3 bg-card-light dark:bg-card-dark border border-border-light dark:border-border-dark rounded-xl p-5 shadow-sm hover:border-primary/30 hover:shadow-md transition-all group"
                                >
                                    <div className="p-2.5 bg-primary/10 rounded-lg shrink-0 group-hover:bg-primary/20 transition-colors">
                                        <Icon className="text-primary text-xl" />
                                    </div>
                                    <div>
                                        <p className="text-sm font-semibold text-text-main dark:text-white group-hover:text-primary transition-colors flex items-center gap-1">
                                            {action.label}
