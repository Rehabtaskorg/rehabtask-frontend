...
export default function RequestFormFooter({
    ...
    return (
        <div className="fixed bottom-0 left-0 lg:left-64 right-0 z-20 bg-card-light  border-t border-border-light ">
                ...
                <div>
                    {currentStep === 1 ? (
                        <button
                            ...
                            className="text-sm text-text-muted  hover:text-text-main  font-bold transition-colors"
                        >
                            Cancel
                        </button>
                    ) : (
                        <button
                            onClick={onBack}
                            className="flex items-center gap-1 text-sm text-text-muted  hover:text-text-main  font-bold transition-colors"
                        >
