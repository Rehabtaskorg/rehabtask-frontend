...
export default function CustomerConversationThreadPage({ params }) {
    ...
    const { messages, loading, error, sendMessage, retryMessage } = useMessages(
        contextType,
        contextId
    );
    ...
    if (contextLoading && !messageDerivedUser) {
        ...
        otherUserName = getDisplayName(otherUser) === 'Unknown User' ? 'Therapist' : getDisplayName(otherUser);
    }
