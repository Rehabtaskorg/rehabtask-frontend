...
// Context label displayed in the header
...
export default function ConversationThreadPage({ params }) {
        ...
        return (
            <div className="py-6 px-4">
                <div className="max-w-3xl mx-auto text-center py-16">
                    <p className="text-text-muted dark:text-gray-400">Invalid conversation type.</p>
                    <Link href="/therapist/messages" className="text-primary text-sm font-medium mt-2 inline-block">
                        Back to Messages
                    </Link>
                </div>
            </div>
    ...
    // Derive other user from first message that has a different sender
    ...
    return (
        <div className="py-6 px-4">
            <div className="max-w-3xl mx-auto">
                ...
                {/* Chat Window */}
                <div className="bg-card-light dark:bg-card-dark rounded-xl border border-border-light dark:border-border-dark shadow-sm overflow-hidden flex flex-col"
