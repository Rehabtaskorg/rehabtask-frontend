...
// Helper: context label & color
const getContextBadge = (currentContext) => {
    const map = {
        request: { label: 'Request', className: 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300' },
        booking: { label: 'Booking', className: 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' },
    }
...
export default function MessagesPage() {
    ...
    const handleSelectConversation = (conversation) => {
        ...
        router.push(`/therapist/messages/${type}/${id}`);
    }
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-sm text-text-muted dark:text-gray-400 mt-1">
                        Your conversations with patients and agencies
                    </p>
                </div>
                ...
                <div className="bg-card-light dark:bg-card-dark rounded-xl border border-border-light dark:border-border-dark shadow-sm overflow-hidden">
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
                            ...
                            <h3 className="font-semibold text-text-main dark:text-white mb-1">No conversations yet</h3>
                            ...
                            {conversations.map((conversation, idx) => {
                                ...
                                return (
                                    <li
                                        ...
                                        className="flex items-center gap-3 px-4 py-3 hover:bg-muted-light dark:hover:bg-muted-dark cursor-pointer transition-colors group"
                                    >
                                        {/* Avatar */}
