...
export default function AdminDashboardPage() {
    ...
    const { data: payStats, isLoading: payLoading } = useAdminPaymentStats();
    const { data: subStats, isLoading: subLoading } = useAdminSubscriptionStats();
    const { data: usersData, isLoading: usersLoading } = useAdminUsers({ limit: 1 });
    const { data: pendingData, isLoading: pendingLoading } = useAdminTherapists({ approvalStatus: 'pending', limit: 5 });
    const { data: disputesData, isLoading: dispLoading } = useAdminDisputes({ status: 'open', limit: 5 });
    const { data: bookingsData, isLoading: bookLoading } = useAdminBookings({ limit: 6 });
